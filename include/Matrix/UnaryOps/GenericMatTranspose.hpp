...
template <typename T>
class GenericMatTranspose : public IMatrix<GenericMatTranspose<T>> {
private:
  // Resources
  T* mp_right{nullptr};
...
public:
  ...
  // Constructor
  constexpr GenericMatTranspose(T* u) : mp_right{u}, m_nidx{this->m_idx_count++} {
...
template <typename T>
using GenericMatTransposeT = GenericMatTranspose<T>;
