/**
 * @file include/Matrix/MatrixHandler/MatrixConvHandler/NaiveCPU/ZeroMatConvHandler.hpp
 *
...
class ZeroMatConvHandler : public T {
    public:
      void handle(const size_t stride_x, const size_t stride_y, const size_t pad_x, const size_t pad_y,  
        ...
        T::handle(stride_x, stride_y, pad_x, pad_y, lhs, rhs, result);
      }
};