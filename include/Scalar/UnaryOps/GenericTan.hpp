...
public:
  ...
  */
  ...
  // Get type
  V_OVERRIDE(std::string_view getType() const) { return "GenericTan"; }
...
template <typename T> const GenericTanT<T> &tan(const IVariable<T> &u) {
