...
public:
  ...
  // Constructor
  constexpr GenericSin(T *u, Callables &&...call) : mp_left{u}, 
...
template <typename T> 
using GenericSinT = GenericSin<T, OpType>;

// Function for sin computation
template <typename T> constexpr const auto &sin(const IVariable<T> &u) {
