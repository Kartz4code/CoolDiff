/**
 * @file include/BinaryOps/GenericPow.hpp
 *
...
public:
    ...
    // Constructor
    GenericPow(T1* u, T2* v, Callables&&... call) : mp_left{ u },
                                                    mp_right{ v },
...
public:
    ...
    // Constructor
    GenericPow(const Type& u, T* v, Callables&&... call) : mp_left{ u },
                                                           mp_right{ v },
                                                           m_caller{ std::make_tuple(std::forward<Callables>(call)...) },
                                                           m_nidx{ this->m_idx_count++ }
    {}
...
public:
    ...
    // Constructor
    GenericPow(T* u, const Type& v, Callables&&... call) : mp_left{ u },
                                                           mp_right{ v },
                                                           m_caller{ std::make_tuple(std::forward<Callables>(call)...) },
                                                           m_nidx{ this->m_idx_count++ }
    {}
...
template <typename T1, typename T2>
const GenericPowT1<T1, T2>& pow(const IVariable<T1>& u, const IVariable<T2>& v) {
