...
void ZeroMatDervConvHandler::handleLHS(
    const size_t nrows_x, const size_t ncols_x, const size_t stride_x,
...
void ZeroMatDervConvHandler::handleRHS(
    const size_t nrows_x, const size_t ncols_x, const size_t stride_x,
    const size_t stride_y, const size_t pad_x, const size_t pad_y,
...
void ZeroMatDervConvHandler::handle(
    const size_t nrows_x, const size_t ncols_x, const size_t stride_x,
    const size_t stride_y, const size_t pad_x, const size_t pad_y,
  ...
  if (auto *it = ZeroMatDervConv((rows * nrows_x), (cols * ncols_x), lhs, dlhs,
                                 rhs, drhs);
      nullptr != it) {
    if (it == rhs) {
  ...
  MatrixHandler::handle(nrows_x, ncols_x, stride_x, stride_y, pad_x, pad_y, lhs,
                        dlhs, rhs, drhs, result);
}