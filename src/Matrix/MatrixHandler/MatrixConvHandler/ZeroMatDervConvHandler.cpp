/**
 * @file src/Matrix/MatrixHandler/MatrixConvHandler/ZeroMatConvHandler.cpp
 *
...
void ZeroMatDervConvHandler::handleLHS(const size_t nrows_x, const size_t ncols_x,
                                       const size_t stride_x, const size_t stride_y, 
                                       const size_t pad_x, const size_t pad_y, 
                                       const size_t crows, const size_t ccols, 
                                       const Matrix<Type>* lhs, const Matrix<Type>* drhs,
                                       Matrix<Type>*& result) {
...
void ZeroMatDervConvHandler::handleRHS(const size_t nrows_x, const size_t ncols_x,
                                       const size_t stride_x, const size_t stride_y, 
                                       const size_t pad_x, const size_t pad_y,  
                                       const size_t lhs_rows, const size_t lhs_cols,
                                       const Matrix<Type>* rhs, const Matrix<Type>* dlhs,
                                       Matrix<Type>*& result) {
  // Stride must be strictly non-negative
  ASSERT(((int)stride_x > 0) && ((int)stride_y > 0), "Stride is not strictly non-negative");
  // Padding must be positive
...
void ZeroMatDervConvHandler::handle(const size_t nrows_x, const size_t ncols_x,
                                    const size_t stride_x, const size_t stride_y, 
                                    const size_t pad_x, const size_t pad_y, 
  ...
  MatrixHandler::handle(nrows_x, ncols_x, 
                        stride_x, stride_y, 
                        pad_x, pad_y, 
                        lhs, dlhs, 
                        rhs, drhs, 
