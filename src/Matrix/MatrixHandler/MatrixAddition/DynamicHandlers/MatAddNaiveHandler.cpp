/**
 * @file src/Matrix/MatrixHandler/MatrixAddition/DynamicHandlers/MatAddNaiveHandler.cpp
 *
...
void MatAddNaiveHandler::handle(const Matrix<Type> *lhs, const Matrix<Type> *rhs, Matrix<Type> *&result) {
