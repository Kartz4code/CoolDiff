...
const std::string &VarWrap::getVariableName() const { return m_var_name; }

void VarWrap::setExpression(const std::string &str) { m_expression = str; }

const std::string &VarWrap::getExpression() const { return m_expression; }

const Type VarWrap::getValue() const { return m_value; }

void VarWrap::setValue(Type val) { m_value = val; }

const Type VarWrap::getdValue() const { return m_dvalue; }

void VarWrap::setdValue(Type val) { m_dvalue = val; }

void VarWrap::setString(const std::string &str) { m_expression = str; }